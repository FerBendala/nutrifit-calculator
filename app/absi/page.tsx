        ...
        <main className="max-w-5xl mx-auto space-golden-lg">
          ...
          <article className="prose prose-gray max-w-none space-golden-lg pt-[2.618rem]">
              ...
              <article className="card-golden space-golden-sm">
                ...
                <ul className="text-sm text-muted-foreground space-golden-xs">
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    ...
                    <span><strong>Predicción de mortalidad:</strong> Mejor que IMC según <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3401091/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium transition-golden">estudios de Krakauer et al.</a></span>
                  </li>
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    <span className="text-green-600 mr-2">•</span>
              ...
              <article className="card-golden space-golden-sm">
                ...
                <div className="space-golden-sm">
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-green-700">Z-score &lt; -1.0 (Muy Bajo):</h4>
                    <p className="text-xs text-muted-foreground mt-1">Riesgo de mortalidad muy bajo, percentil &lt;16%</p>
                  </section>
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-blue-700">Z-score -1.0 a -0.5 (Bajo):</h4>
                    <p className="text-xs text-muted-foreground mt-1">Riesgo bajo, percentil 16-31%</p>
                  </section>
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-yellow-700">Z-score -0.5 a 0.5 (Moderado):</h4>
                    <p className="text-xs text-muted-foreground mt-1">Riesgo promedio, percentil 31-69%</p>
                  </section>
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-orange-700">Z-score 0.5 a 1.0 (Alto):</h4>
                    <p className="text-xs text-muted-foreground mt-1">Riesgo elevado, percentil 69-84%</p>
                  </section>
                  <section className="py-[0.382rem]">
                    <h4 className="font-semibold text-sm text-red-700">Z-score &gt; 1.0 (Muy Alto):</h4>
            ...
            <section className="bg-blue-50 card-golden-lg border-l-4 border-blue-400 mb-[2.618rem]">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">Fórmula ABSI (Krakauer & Krakauer, 2012):</h4>
                ...
                <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">Z-Score (Estandarización):</h4>
                  <div className="font-mono text-sm mb-2 bg-gray-50 p-3 rounded">
            ...
            <section className="space-y-4 mb-[2.618rem]">
              <h3 className="text-lg font-medium">❓ Preguntas frecuentes sobre ABSI</h3>
              <div className="space-y-3">
                <article className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    juntos ofrecen una evaluación más completa. Consulta también nuestra <a href="/imc" className="text-blue-600 hover:underline">calculadora de IMC</a>.
                  </p>
                </article>
                <article className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Consulta nuestra <a href="/tdee" className="text-blue-600 hover:underline">calculadora de TDEE</a> para planificar tu déficit.
                  </p>
                </article>
                <article className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    medida más compleja que predice mortalidad. El <a href="/whtr" className="text-blue-600 hover:underline">WHtR</a> es más simple (cintura/altura)
            ...
            <section className="bg-orange-50 card-golden-lg border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <ul className="text-sm text-orange-800 space-golden-xs">
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/imc" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora de IMC:</a></strong> Complementa el ABSI con evaluación de peso corporal general</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/grasa-corporal" className="text-blue-600 hover:underline font-medium transition-golden">Grasa Corporal:</a></strong> Porcentaje de grasa corporal para evaluación completa</span>
                </li>
              </ul>
            </section>
