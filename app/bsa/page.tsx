        ...
        <main className="max-w-5xl mx-auto space-golden-lg">
          <header className="text-center space-golden-md">
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight leading-[1.1] mb-[1.618rem]">
              Calculadora BSA Médica
            </h1>
            <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto leading-[1.618] font-light">
              Calculadora profesional de BSA (Body Surface Area - Superficie Corporal) con 5 fórmulas científicas validadas.
              Esencial para dosificación de quimioterapia, cálculo cardiaco, fluidos intravenosos y nutrición hospitalaria.
            </p>
          </header>
                ...
                <div className="space-golden-lg">
                  ...
                  <div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {result.comparison.map((formula, index) => (
                        <Card key={index} className={formula.formula === 'Du Bois' ? 'border-2 border-blue-400 bg-blue-50/50' : ''}>
                          ...
                          <CardContent>
                            ...
                            {formula.difference !== 0 && (
                              <div className={`text-xs ${formula.difference > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Card className="bg-purple-50 border-l-4 border-purple-400">
                      ...
                      <CardContent className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-700">Dosis estándar:</span>
                          <span className="font-bold text-purple-700">{result.clinicalApplications.chemotherapy.doseArea} mg/m²</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t">
                          <span className="text-sm text-gray-700">Dosis calculada:</span>
                          <span className="font-bold text-lg text-purple-800">{result.clinicalApplications.chemotherapy.exampleDose} mg</span>
                        </div>
                    ...
                    <Card className="bg-red-50 border-l-4 border-red-400">
                      ...
                      <CardContent className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-700">Gasto cardíaco:</span>
                          <span className="font-bold text-red-700">{result.clinicalApplications.cardiacIndex.cardiacOutput} L/min</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t">
                          <span className="text-sm text-gray-700">Volumen sistólico:</span>
                          <span className="font-bold text-lg text-red-800">{result.clinicalApplications.cardiacIndex.strokeVolume} mL</span>
                        </div>
                    ...
                    <Card className="bg-cyan-50 border-l-4 border-cyan-400">
                      ...
                      <CardContent className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-700">Mantenimiento diario:</span>
                          <span className="font-bold text-cyan-700">{result.clinicalApplications.fluidResuscitation.maintenanceFluids} mL/día</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t">
                          <span className="text-sm text-gray-700">Resucitación quemaduras (20%):</span>
                    ...
                    <Card className="bg-green-50 border-l-4 border-green-400">
                      ...
                      <CardContent className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-700">Calorías totales:</span>
                          <span className="font-bold text-green-700">{result.clinicalApplications.nutritionalSupport.totalCalories} kcal/día</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t">
                          <span className="text-sm text-gray-700">Proteína:</span>
                          <span className="font-bold text-lg text-green-800">{result.clinicalApplications.nutritionalSupport.proteinNeeds} g/día</span>
                        </div>
                      ...
                      <div className="space-y-3">
                        {result.clinicalApplications.drugDosage.examples.map((drug, index) => (
                          <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <div>
                              <div className="font-semibold text-sm text-gray-900">{drug.drug}</div>
                              <div className="text-xs text-gray-600">{drug.dosePerBSA}</div>
                            </div>
                            <div className="text-right">
                              <div className="font-bold text-lg text-blue-700">{drug.calculatedDose}</div>
          ...
          <article className="prose prose-gray max-w-none space-golden-lg pt-[2.618rem]">
              ...
              <article className="card-golden space-golden-sm">
                ...
                <ul className="text-sm text-muted-foreground space-golden-xs">
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    ...
                    <span><strong>Quimioterapia:</strong> Dosificación estándar por m² según <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium transition-golden">protocolos NCCN</a></span>
                  </li>
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                  ...
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    ...
                    <span><strong>Antibióticos:</strong> Ajuste de dosis en pacientes con IMC extremo según <a href="/peso-ajustado" className="text-blue-600 hover:underline">ABW y BSA</a></span>
                  </li>
              ...
              <article className="card-golden space-golden-sm">
                ...
                <div className="space-golden-sm">
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-blue-700">Du Bois (1916) - Estándar de oro:</h4>
                  ...
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-green-700">Mosteller (1987) - Pediátrica:</h4>
                  ...
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-purple-700">Haycock (1978):</h4>
                  ...
                  <section className="py-[0.382rem]">
                    <h4 className="font-semibold text-sm text-orange-700">Gehan & Boyd:</h4>
            ...
            <section className="bg-purple-50 card-golden-lg border-l-4 border-purple-400 mb-[2.618rem]">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <article>
                  ...
                  <ul className="text-sm text-purple-800 space-y-1">
                    <li>• <strong>Obesidad:</strong> Algunos protocolos usan <a href="/peso-ajustado" className="text-blue-600 hover:underline">peso ajustado (ABW)</a> o BSA corregido</li>
            ...
            <section className="bg-red-50 card-golden-lg border-l-4 border-red-400 mb-[2.618rem]">
            ...
            <section className="space-y-4 mb-[2.618rem]">
              <h3 className="text-lg font-medium">❓ Preguntas frecuentes sobre BSA</h3>
              <div className="space-y-3">
                ...
                <article className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ambos son herramientas complementarias. El <a href="/peso-ajustado" className="text-blue-600 hover:underline">peso ajustado (ABW)</a> corrige
            ...
            <section className="bg-orange-50 card-golden-lg border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <ul className="text-sm text-orange-800 space-golden-xs">
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/peso-ajustado" className="text-blue-600 hover:underline font-medium transition-golden">Peso Ajustado Clínico (ABW):</a></strong> Complementa el BSA en pacientes con obesidad para dosificación precisa</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/imc" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora IMC:</a></strong> Útil para identificar pacientes que requieren ajustes en dosificación</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/peso-ideal" className="text-blue-600 hover:underline font-medium transition-golden">Peso Ideal:</a></strong> Referencia para evaluar si se requiere ABW o BSA corregido</span>
                </li>
              </ul>
            </section>
