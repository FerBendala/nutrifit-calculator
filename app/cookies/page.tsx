      ...
      <main className="max-w-5xl mx-auto space-golden-lg">
        ...
        <article className="prose prose-gray max-w-none space-golden-lg">
            ...
            <div className="grid gap-[1.618rem] md:grid-cols-3 mb-[2.618rem]">
              <article className="card-golden space-golden-sm bg-green-50 dark:bg-green-950/30">
                ...
                <div className="card-golden bg-green-100 border-l-4 border-green-500 mb-[1rem]">
                  <p className="text-xs text-green-800 dark:text-green-200 mb-0 font-medium">
              ...
              <article className="card-golden space-golden-sm bg-blue-50 dark:bg-blue-950/30">
                <h3 className="text-xl font-semibold mb-[0.618rem] flex items-center text-blue-700 dark:text-blue-300">
                  <span className="text-2xl mr-3">📈</span>
                  2.2 Cookies analíticas
                </h3>
                <div className="card-golden bg-blue-100 border-l-4 border-blue-500 mb-[1rem]">
                  <p className="text-xs text-blue-800 dark:text-blue-200 mb-0 font-medium">
              ...
              <article className="card-golden space-golden-sm bg-yellow-50 dark:bg-yellow-950/30">
                <h3 className="text-xl font-semibold mb-[0.618rem] flex items-center text-yellow-700 dark:text-yellow-300">
                  <span className="text-2xl mr-3">💰</span>
                  2.3 Cookies publicitarias
                </h3>
                <div className="card-golden bg-yellow-100 border-l-4 border-yellow-500 mb-[1rem]">
                  <p className="text-xs text-yellow-800 dark:text-yellow-200 mb-0 font-medium">
                  ...
                  <tbody>
                    <tr className="hover:bg-muted">
                      ...
                      <td className="border border-gray-300 p-3">
                        <span className="px-2 py-1 bg-green-100 text-green-800 dark:text-green-200 rounded-full text-xs font-medium">
                          Necesaria
                        </span>
                      </td>
                    ...
                    <tr className="hover:bg-muted">
                      ...
                      <td className="border border-gray-300 p-3">
                        <span className="px-2 py-1 bg-blue-100 text-blue-800 dark:text-blue-200 rounded-full text-xs font-medium">
                          Analítica
                        </span>
                      </td>
                    ...
                    <tr className="hover:bg-muted">
                      ...
                      <td className="border border-gray-300 p-3">
                        <span className="px-2 py-1 bg-yellow-100 text-yellow-800 dark:text-yellow-200 rounded-full text-xs font-medium">
                          Publicitaria
                        </span>
                      </td>
                      <td className="border border-gray-300 p-3">2 años</td>
          ...
          <section className="card-golden-lg bg-purple-50 dark:bg-purple-950/30 border-l-4 border-purple-400 mb-[2.618rem]">
            ...
            <p className="text-sm text-purple-800 dark:text-purple-200 leading-[1.618] mb-[1rem]">
          ...
          <section>
            ...
            <div className="card-golden-lg bg-orange-50 dark:bg-orange-950/30 border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <div className="grid gap-[1.618rem] md:grid-cols-2">
                <article className="card-golden bg-card/50">
                  <h4 className="font-bold mb-[0.618rem] text-green-700 dark:text-green-300">✅ Funcional</h4>
                ...
                <article className="card-golden bg-card/50">
                  <h4 className="font-bold mb-[0.618rem] text-orange-700 dark:text-orange-300">⚠️ Limitaciones</h4>
                  <ul className="text-sm text-orange-800 dark:text-orange-200 space-golden-xs">
                    <li className="flex items-start">
                      <span className="text-red-600 dark:text-red-400 mr-2">•</span>
          ...
          <section className="bg-green-50 dark:bg-green-950/30 card-golden-lg border-l-4 border-green-400 mb-[2.618rem]">
            ...
            <div className="grid gap-[1.618rem] md:grid-cols-2">
              <article className="card-golden bg-card/50">
                <h4 className="font-bold mb-[0.618rem] text-green-700 dark:text-green-300">📧 Contacto</h4>
                <ul className="text-sm text-green-800 dark:text-green-200 space-golden-xs">
              ...
              <article className="card-golden bg-card/50">
                <h4 className="font-bold mb-[0.618rem] text-green-700 dark:text-green-300">🔄 Actualizaciones</h4>
          ...
          <section className="bg-blue-50 dark:bg-blue-950/30 card-golden-lg border-l-4 border-blue-400">
