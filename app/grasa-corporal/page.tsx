          ...
          <article className="prose prose-gray max-w-none space-golden-lg pt-[2.618rem]">
            ...
            <section className="bg-orange-50 card-golden-lg border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <ul className="text-sm text-orange-800 space-golden-xs">
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/fmi" className="text-blue-600 hover:underline font-medium transition-golden">Calcula tu FMI avanzado:</a></strong> Índice preciso de masa grasa para evaluación metabólica completa</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/bai" className="text-blue-600 hover:underline font-medium transition-golden">Calcula BAI sin báscula:</a></strong> Estima grasa corporal con solo cadera y altura según Bergman</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
