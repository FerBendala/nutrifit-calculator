        ...
        <main className="max-w-5xl mx-auto space-golden-lg">
          <header className="text-center space-golden-md">
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight leading-[1.1] mb-[1.618rem]">
              Calculadora Grasa Visceral Médica
            </h1>
          ...
          <section className="card-golden-lg bg-blue-50 border-l-4 border-blue-400 mb-8">
            <div className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                calculadoras de distribución de grasa como <a href="/ci" className="text-blue-600 hover:underline">CI</a>,
                <a href="/bri" className="text-blue-600 hover:underline">BRI</a>, <a href="/absi" className="text-blue-600 hover:underline">ABSI</a> y
                <a href="/whtr" className="text-blue-600 hover:underline">WHtR</a>.
              </p>
            </div>
          </section>
          ...
          <article className="prose prose-gray max-w-none space-golden-lg pt-[2.618rem]">
            ...
            <section className="bg-blue-50 card-golden-lg border-l-4 border-blue-400 mb-[2.618rem]">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">Fórmula Lee et al. (2008):</h4>
                ...
                <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">Fórmula Ryo et al. (2005):</h4>
                  <div className="font-mono text-sm mb-2 bg-gray-50 p-3 rounded">
            ...
            <section className="space-y-4 mb-[2.618rem]">
              <h3 className="text-lg font-medium">❓ Preguntas frecuentes sobre grasa visceral</h3>
            ...
            <section className="bg-orange-50 card-golden-lg border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <ul className="text-sm text-orange-800 space-golden-xs">
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/ci" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora de CI:</a></strong> Complementa el VAT con evaluación de distribución de grasa abdominal</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/bri" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora de BRI:</a></strong> Complementa el VAT con predicción de riesgo metabólico</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/grasa-corporal" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora de Grasa Corporal:</a></strong> Porcentaje total de grasa corporal</span>
                </li>
              </ul>
            </section>
