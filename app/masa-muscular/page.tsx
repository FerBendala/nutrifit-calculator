    ...
    <>
      ...
      <Container size="xl" className="py-[4.236rem]">
        <main className="max-w-5xl mx-auto space-golden-lg">
          ...
          <section className="card-golden-lg bg-orange-50 dark:bg-orange-950/30 border-l-4 border-orange-400">
            <header className="p-6 pb-0">
              <h2 className="text-xl font-semibold text-orange-800 dark:text-orange-200 flex items-center">
            ...
            <div className="p-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <article className="card-golden bg-card/50">
                  <h3 className="font-semibold text-orange-700 dark:text-orange-300 mb-2 flex items-center">
                ...
                <div className="space-golden-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <article className="text-center p-6 bg-blue-50 dark:bg-blue-950/30 rounded-lg border-l-4 border-blue-400">
                      ...
                      <div className="text-sm font-medium text-blue-800 dark:text-blue-200">Masa Muscular</div>
                    </article>
                    ...
                    <article className="text-center p-6 bg-green-50 dark:bg-green-950/30 rounded-lg border-l-4 border-green-400">
                      ...
                      <div className="text-sm font-medium text-green-800 dark:text-green-200">Índice de Masa Muscular</div>
                    </article>

                    <article className="text-center p-6 bg-purple-50 dark:bg-purple-950/30 rounded-lg border-l-4 border-purple-400">
                      <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">
                        {result.muscleMassPercentage}%
                      </div>
                      <div className="text-sm font-medium text-purple-800 dark:text-purple-200">% Masa Muscular</div>
                    </article>
          ...
          <article className="prose prose-gray max-w-none space-golden-lg pt-[2.618rem]">
                ...
                <div className="p-6">
                  <ul className="space-y-2 text-green-800 dark:text-green-200">
                    <li className="flex items-start">
                      ...
                      <span><strong>Metabolismo acelerado:</strong> Quema más calorías en reposo - <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3871410/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium transition-golden">estudios sobre metabolismo</a></span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-green-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <section className="card-golden-lg bg-purple-50 dark:bg-purple-950/30 border-l-4 border-purple-400 mt-8">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <article>
                    <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-3">Índice de Masa Muscular (IMM)</h4>
                  ...
                  <article>
                    <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-3">Categorías de Referencia</h4>
                    <p className="text-sm text-purple-700 dark:text-purple-300 leading-relaxed">
            ...
            <section className="card-golden-lg bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-400 mt-8">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <article>
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-3">Entrenamiento</h4>
                  ...
                  <article>
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-3">Nutrición</h4>
                    <ul className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
            ...
            <section className="card-golden-lg bg-orange-50 dark:bg-orange-950/30 border-l-4 border-orange-400 mt-8">
              ...
              <div className="p-6">
                <ul className="text-sm text-orange-800 dark:text-orange-200 space-golden-xs">
                  ...
                  <li className="flex items-start">
                    <span className="text-orange-600 dark:text-orange-400 mr-2">•</span>
                    <span><strong><a href="/" className="text-blue-600 dark:text-blue-400 hover:underline font-medium transition-golden">Calcula tus calorías:</a></strong> Ajusta tu alimentación para ganancia muscular</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-600 dark:text-orange-400 mr-2">•</span>
