          ...
          <article className="space-golden-lg pt-[2.618rem]">
            ...
            <section className="bg-orange-50 card-golden-lg border-l-4 border-orange-400 mb-[2.618rem]">
              ...
              <ul className="text-sm text-orange-800 space-golden-xs">
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/rmr" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de RMR:</a></strong> Tasa metabólica en reposo más práctica que BMR para uso diario</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/absi" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de ABSI:</a></strong> A Body Shape Index que predice mortalidad mejor que el IMC solo</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/ci" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de CI:</a></strong> Conicity Index que evalúa distribución de grasa abdominal y riesgo cardiovascular</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/grasa-visceral" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de Grasa Visceral:</a></strong> VAT con 2 fórmulas científicas para estimar tejido adiposo visceral</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/masa-magra" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de Masa Magra:</a></strong> LBM con 4 fórmulas científicas para evaluación de composición corporal</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/edad-metabolica" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de Edad Metabólica:</a></strong> Compara tu metabolismo con el promedio de tu edad cronológica</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/presion-arterial-media" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de Presión Arterial Media (MAP):</a></strong> Evaluación de perfusión de órganos y riesgo cardiovascular según guías AHA/ACC</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/recuperacion-cardiaca" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de Recuperación Cardíaca (HRR):</a></strong> Evaluación de condición cardiovascular y función autonómica después del ejercicio</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/egfr" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de eGFR (Filtrado Glomerular):</a></strong> Estimación de función renal con CKD-EPI, MDRD y Cockcroft-Gault para estadificación de ERC</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/vo2max" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de VO2 Max:</a></strong> Capacidad cardiovascular con 4 métodos científicos</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/whr" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de WHR:</a></strong> Ratio cintura-cadera según estándares OMS para riesgo cardiovascular</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span><strong><a href="/fmi" className="text-blue-600 hover:underline font-medium transition-golden">Calculadora médica de FMI:</a></strong> Índice de masa grasa según estándares Schutz para evaluación metabólica</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
