          ...
          <section className="card-golden-lg bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-400 mb-8">
            <div className="p-6">
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/6930408/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium transition-golden">
                  Robinson (1983)
                </a>{' '}
                para el peso ideal y ajusta según composición corporal. Estudios en{' '}
                <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium transition-golden">
                ...
                <form onSubmit={handleSubmit} className="space-golden-md">
                  <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 mb-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-blue-800 dark:text-blue-200 mb-1">Peso Ajustado para Uso Clínico</h3>
            ...
            <section className="space-golden-lg border-t pt-8">
              <header className="mb-6">
                <h2 className="text-2xl font-bold text-foreground flex items-center">
                  <Scale className="w-6 h-6 mr-2 text-orange-600 dark:text-orange-400" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center text-lg">
                      <Scale className="w-5 h-5 mr-2 text-green-600 dark:text-green-400" />
                      Peso Ideal
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-2 border-orange-500">
                  <CardHeader>
                    <CardTitle className="flex items-center text-lg">
                      <Scale className="w-5 h-5 mr-2 text-orange-600 dark:text-orange-400" />
                      Peso Ajustado (ABW)
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <Card className="mb-6">
                <CardHeader>
                  <CardTitle className="flex items-center text-lg">
                    <Pill className="w-5 h-5 mr-2 text-purple-600 dark:text-purple-400" />
                    Guía de Uso Clínico
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                      ...
                      <div>
                        <p className="font-semibold text-blue-900 dark:text-blue-100">Usar Peso Ajustado</p>
                        <p className="text-sm text-blue-700 dark:text-blue-300">{result.clinicalUse.reason}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border-2 border-green-500">
                        <p className="text-sm text-green-700 dark:text-green-300">Recomendado</p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="p-3 bg-orange-50 dark:bg-orange-950/30 rounded-lg border-2 border-orange-500">
                        <p className="text-sm text-orange-700 dark:text-orange-300">Recomendado</p>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{result.bmiActual.toFixed(1)}</p>
                    </div>
                    <div className="text-center p-4 bg-green-50 dark:bg-green-950/30 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-2">IMC Ideal</p>
                      <p className="text-2xl font-bold text-green-600 dark:text-green-400">{result.bmiIdeal.toFixed(1)}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <article className="card-golden space-golden-sm">
                ...
                <ul className="text-sm text-muted-foreground space-golden-xs">
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                    <span><strong>Dosificación de fármacos:</strong> Antibióticos, quimioterapia y anestésicos según <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium transition-golden">guías farmacológicas</a></span>
                  </li>
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
              ...
              <article className="card-golden space-golden-sm">
                ...
                <div className="space-golden-sm">
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-orange-700 dark:text-orange-300">En obesidad:</h4>
                  ...
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-blue-700 dark:text-blue-300">En bajo peso:</h4>
                    <ul className="text-sm text-muted-foreground mt-1 space-y-1">
                  ...
                  <section className="py-[0.382rem]">
                    <h4 className="font-semibold text-sm text-green-700 dark:text-green-300">Con ABW:</h4>
                    <ul className="text-sm text-muted-foreground mt-1 space-y-1">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="bg-card p-4 rounded-lg border-2 border-blue-200">
                    <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">1. Peso Ideal Robinson (1983)</h4>
                    <div className="font-mono text-sm mb-2">
                      <p>Hombres: 52 kg + 1.9 kg por pulgada sobre 5 pies</p>
                      <p>Mujeres: 49 kg + 1.7 kg por pulgada sobre 5 pies</p>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Fórmula más usada en práctica clínica - <a href="https://pubmed.ncbi.nlm.nih.gov/6930408/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">validación original</a>
                    </p>
                  </div>

                  <div className="bg-card p-4 rounded-lg border-2 border-blue-200">
                    <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">2. Peso Ajustado (ABW)</h4>
                    <div className="font-mono text-sm mb-2">
                      <p>ABW = Peso Ideal + 0.4 × (Peso Actual - Peso Ideal)</p>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Factor 0.4 estándar en nutrición clínica - <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">evidencia farmacológica</a>
                    </p>
                  </div>

                  <div className="bg-card p-4 rounded-lg border-2 border-blue-200">
                    <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">3. Cuándo Usar Cada Peso</h4>
