...
import { PesoAjustadoCalculator } from './PesoAjustadoCalculator';
        ...
        <main className="max-w-5xl mx-auto space-golden-lg">
          <header className="text-center space-golden-md">
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight leading-[1.1] mb-[1.618rem]">
              Calculadora de Peso Ajustado (ABW) – Tu Peso para Cálculos Nutricionales
            </h1>
          ...
          <section className="card-golden-lg bg-info-subtle border-l-4 border-info mb-8">
            <div className="p-6">
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/6930408/" target="_blank" rel="noopener noreferrer" className="text-info hover:underline transition-colors font-medium transition-golden">
                  Robinson (1983)
                </a>{' '}
                para el peso ideal y ajusta según composición corporal. Estudios en{' '}
                <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-info hover:underline transition-colors font-medium transition-golden">
              ...
              <article className="card-golden space-golden-sm">
                ...
                <ul className="text-sm text-muted-foreground space-golden-xs">
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    ...
                    <span><strong>Dosificación de fármacos:</strong> Antibióticos, quimioterapia y anestésicos según <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-info hover:underline transition-colors font-medium transition-golden">guías farmacológicas</a></span>
                  </li>
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                  ...
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    ...
                    <span><strong>Enfermedad renal:</strong> Prescripción de proteínas según <a href="/proteina/" className="text-info hover:underline transition-colors">necesidades ajustadas</a></span>
                  </li>
                  <li className="flex items-start py-[0.382rem] border-b border-border/30">
                    <span className="text-warning mr-2">•</span>
              ...
              <article className="card-golden space-golden-sm">
                ...
                <div className="space-golden-sm">
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-warning">En obesidad:</h4>
                  ...
                  <section className="py-[0.382rem] border-b border-border/30">
                    <h4 className="font-semibold text-sm text-info">En bajo peso:</h4>
                    <ul className="text-sm text-muted-foreground mt-1 space-y-1">
                  ...
                  <section className="py-[0.382rem]">
                    <h4 className="font-semibold text-sm text-success">Con ABW:</h4>
                    <ul className="text-sm text-muted-foreground mt-1 space-y-1">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <article>
                  ...
                  <ul className="text-sm text-foreground space-y-1">
                    ...
                    <li>• Preserva masa muscular con <a href="/proteina/" className="text-info hover:underline transition-colors">proteína adecuada</a></li>
                  </ul>
                </article>
                <article>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="bg-card p-4 rounded-lg border-2 border-info">
                    <h4 className="font-semibold text-foreground mb-2">1. Peso Ideal Robinson (1983)</h4>
                    <div className="font-mono text-sm mb-2">
                      <p>Hombres: 52 kg + 1.9 kg por pulgada sobre 5 pies</p>
                      <p>Mujeres: 49 kg + 1.7 kg por pulgada sobre 5 pies</p>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Fórmula más usada en práctica clínica - <a href="https://pubmed.ncbi.nlm.nih.gov/6930408/" target="_blank" rel="noopener noreferrer" className="text-info hover:underline transition-colors font-medium">validación original</a>
                    </p>
                  </div>

                  <div className="bg-card p-4 rounded-lg border-2 border-info">
                    <h4 className="font-semibold text-foreground mb-2">2. Peso Ajustado (ABW)</h4>
                    <div className="font-mono text-sm mb-2">
                      <p>ABW = Peso Ideal + 0.4 × (Peso Actual - Peso Ideal)</p>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Factor 0.4 estándar en nutrición clínica - <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4163889/" target="_blank" rel="noopener noreferrer" className="text-info hover:underline transition-colors font-medium">evidencia farmacológica</a>
                    </p>
                  </div>

                  <div className="bg-card p-4 rounded-lg border-2 border-info">
                    <h4 className="font-semibold text-foreground mb-2">3. Cuándo Usar Cada Peso</h4>
              ...
              <div className="p-6">
                <ul className="space-y-3 text-foreground/90">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>
                        <a href="/peso-ideal/" className="text-info hover:underline transition-colors font-medium transition-golden">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>
                        <a href="/bsa/" className="text-info hover:underline transition-colors font-medium transition-golden">
                          Calcula tu BSA:
                        </a>
                      </strong>{' '}
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>
                        <a href="/egfr/" className="text-info hover:underline transition-colors font-medium transition-golden">
