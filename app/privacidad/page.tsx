...
export const metadata = {
  title: 'Política de Privacidad - Calculadora Fitness',
  description: 'Información sobre cómo recopilamos, usamos y protegemos tus datos personales en Calculadora Fitness.',
};
  ...
  return (
    <Container className="py-8">
      <div className="max-w-4xl mx-auto prose prose-gray">
        ...
        <ul>
          <li>Email: privacy@calculadora-fitness.com</li>
